...
# Σύνοψη
Στα πλαίσια του μαθήματος **Τεχνολογία Λογισμικού** εκπονήθηκε η παρούσα εργασία από τον **Αριστείδη Καρρά(Π2013020)** κατά το εξάμηνο 2016-2017, η οποία σχετίζεται με την δημιουργία ενός παιχνιδιού PacMan σε HTML5 με την βοήθεια της βιβλιοθήκης Phaser.
